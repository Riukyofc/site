...
// Aurora gradient background - animated blobs (responsive sizes)
const AuroraBackground = memo(() => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] md:w-[600px] md:h-[600px] rounded-full bg-[#00BFFF]/15 blur-[80px] sm:blur-[100px] md:blur-[120px] animate-aurora" />
    <div className="absolute top-1/3 right-1/4 w-[250px] h-[250px] sm:w-[375px] sm:h-[375px] md:w-[500px] md:h-[500px] rounded-full bg-[#FF1493]/12 blur-[80px] sm:blur-[100px] md:blur-[120px] animate-aurora" style={{ animationDelay: '-7s' }} />
    <div className="absolute bottom-1/4 left-1/3 w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] rounded-full bg-[#8B5CF6]/10 blur-[80px] sm:blur-[100px] md:blur-[120px] animate-aurora" style={{ animationDelay: '-14s' }} />
  </div>
));
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10 w-full text-center">
        <div className="flex flex-col items-center space-y-6 sm:space-y-8">
          ...
          <FadeIn delay={300}>
            <h1 className="text-[2.5rem] sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-[-0.04em] leading-[1.05] text-white max-w-5xl mx-auto">
              Criamos o{' '}
          ...
          <FadeIn delay={900} className="pt-10 sm:pt-16 w-full max-w-4xl mx-auto">
            {/* Mobile: horizontal scroll */}
            <div className="flex lg:hidden overflow-x-auto snap-x gap-4 pb-2 -mx-4 px-4">
              {featureBadges.map((item, i) => (
                <div key={i} className={`border-l-2 ${item.color} pl-4 min-w-[200px] snap-item shrink-0`}>
      ...
      {/* Scroll indicator */}
      <div className={`absolute bottom-6 left-1/2 -translate-x-1/2 transition-opacity duration-500 ${scrolled ? 'opacity-0' : 'opacity-60'}`}>
